...
\begin{enumerate}
    ...
    \item determining witch service are running or listening
...
ICMP ECHO REQUEST, ICMP ECHO REPLY,ICMP TIMESTAMP,ICMP ADDRESS MASK
Ping: OS utilities for ECHO RREQUEST/REPLY